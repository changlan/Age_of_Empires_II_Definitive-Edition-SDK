...
IMGUI_API void PushID(
    const char* str_id);  // push string identifier into the ID stack. IDs ==
                          // hash of the entire stack!
...
enum ImGuiTabBarFlags_ {
  ...
  ImGuiTabBarFlags_FittingPolicyResizeDown =
      1 << 5,  // Resize tabs when they don't fit
  ImGuiTabBarFlags_FittingPolicyScroll =
      1 << 6,  // Add scroll buttons when tabs don't fit
