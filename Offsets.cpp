...
// Functions
int64_t printNotification = 0xCA8AC0;  // 48 83 EC 48 48 8B 05 ? ? ? ? 4C 8D
                                       // //4
int64_t printBottomText = 0xc92480;  // 48 8B C4 48 83 EC 78 F3 0F 10 05 ? ? ? ?
                                     // 41			//4

// E8 ? ? ? ? 90 48 8B 05 ? ? ? ? F2  - 0x94
// //1
int64_t sendChat = 0xa16090;

int64_t createUnitHook = 0xeadf40;  // 48 89 5C 24 ? 48 89 6C 24 ? 57 48 83 EC
                                    // 20 8B 41		//4
